...
class Reindex_model extends CI_Model {
    ...
    {
        $this->db_old->select('*');
        $this->db_old->from('Nic_admin');
        $this->db_old->where('cron', '');
		$this->db_old->limit($param['limit'], $param['offset']);
        $query = $this->db_old->get();
        return $query;
    }
    
    function old_admin_update($id, $param)
    {
        $this->db_old->where('admin_id', $id);
        $query = $this->db_old->update('Nic_admin', $param);
        return $query;
    }
    ...
    {
        $this->db_old->where('event_id', $id);
        $query = $this->db_old->update('Nic_events', $param);
        return $query;
    }
    ...
    {
        $this->db_old->where('faq_id', $id);
        $query = $this->db_old->update('Nic_faq', $param);
        return $query;
    }
    ...
    {
        $this->db_old->select('*');
        $this->db_old->from('Delivery_cost');
        $this->db_old->where('cron', '');
		$this->db_old->limit($param['limit'], $param['offset']);
        $query = $this->db_old->get();
        return $query;
    ...
    {
        $this->db_old->where('city_id', $id);
        $query = $this->db_old->update('Delivery_cost', $param);
        return $query;
    }
    ...
    {
        $this->db_old->select('*');
        $this->db_old->from('Nic_member');
		$this->db_old->where('acct_id', $param['acct_id']);
        $query = $this->db_old->get();
        return $query;
    }
    ...
    {
        $this->db_old->where('trf_id', $id);
        $query = $this->db_old->update('Nic_transfer', $param);
        return $query;
    }
    
    function old_member_update($id, $param)
    {
        $this->db_old->where('acct_id', $id);
        $query = $this->db_old->update('Nic_member', $param);
        return $query;
    }
    ...
    {
        $this->db_old->select('*');
        $this->db_old->from('nav_menu_old');
		$this->db_old->where('nav_menu_id', $param['nav_menu_id']);
        $query = $this->db_old->get();
        return $query;
    }
    ...
    {
        $this->db_old->where('id_nav_menu', $id);
        $query = $this->db_old->update('nav_menu_old', $param);
        return $query;
    }
    ...
    {
        $this->db_old->where('nav_user_id', $id);
        $query = $this->db_old->update('nav_user_old', $param);
        return $query;
    }
    ...
    {
        $this->db_old->where('post_id', $id);
        $query = $this->db_old->update('Nic_archive', $param);
        return $query;
    }
    ...
    {
        $this->db_old->select('*');
        $this->db_old->from('Nic_post');
		$this->db_old->where('post_id', $param['post_id']);
        $query = $this->db_old->get();
        return $query;
    }
    ...
    {
        $this->db_old->where('post_id', $id);
        $query = $this->db_old->update('Nic_post', $param);
        return $query;
    }
    ...
    {
        $this->db_old->select('*');
        $this->db_old->from('Ind_provinces');
		$this->db_old->where('prov_id', $param['prov_id']);
        $query = $this->db_old->get();
        return $query;
    }
    ...
    {
        $this->db_old->select('*');
        $this->db_old->from('Nic_preferences');
        $this->db_old->where('cron', '');
		$this->db_old->limit($param['limit'], $param['offset']);
        $query = $this->db_old->get();
        return $query;
    ...
    {
        $this->db_old->where('pref_id', $id);
        $query = $this->db_old->update('Nic_preferences', $param);
        return $query;
    }
    ...
    {
        $this->db_old->where('prov_id', $id);
        $query = $this->db_old->update('Ind_provinces', $param);
        return $query;
    }
