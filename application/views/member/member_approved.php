<div class="row" id="member_approved_page">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Member - Approved</h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo $this->config->item('link_member_approved').'?id='.$member->id_member; ?>" method="post" class="form-horizontal">
                    ...
                    <div class="form-actions">
                        <button type="submit" name="submit" value="Submit" class="btn blue" id="submit_member_approved">
